...
- **Style C: 华为企业汇报**。白灰底、Huawei red、右上品牌位、目录红栏、流程箭头和数据条形图,适合公司总结、工作计划、商务汇报。
...
- 🖋 **三套视觉系统**:电子杂志风负责叙事,瑞士风负责事实表达,华为企业汇报风负责红灰公司总结
...
- 🧾 **Style C 36 种企业汇报/商业计划版式**:Huawei Cover、Agenda、Section、Timeline、Data Bars、Process Arrow、Image Grid、KPI Dashboard、Map Locations、Photo Quote、Market Size、Pricing Table、SWOT、Gantt 等
...
| 公司总结 / 工作计划 / 商务汇报 | 用 Style C 华为企业汇报风,优先使用 H01-H36 企业/商业计划版式 |
...
6. **自检** — 对照 `references/checklist.md`,P0 级问题必须全过；瑞士风和华为企业汇报风还要运行对应版式校验器
7. **预览** — 浏览器直接打开
